...
from VisionTransformerCodec import VisionTransformerCodec
...
def options():
    ...
    parser.add_argument(
        ...
        nargs=2,
        default=(256, 256),
        help="Size of the images to be cropped (default: %(default)s)",
    )
    parser.add_argument(
        "--patch-size",
        type=int,
...
if __name__ == '__main__':
    ...
    train_transforms = transforms.Compose(
        [transforms.RandomCrop(args.image_size), transforms.ToTensor()]
    )
    ...
    model = VisionTransformerCodec(image_size=args.image_size, patch_size=args.patch_size, in_channel=3, multi_head=1, N=192)
    net = model.to(device)
